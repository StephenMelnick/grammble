...
RSpec.describe GramsController, type: :controller do
  describe "grams#destory action" do
    ...
    it "shouldn't let unauthenticated users destory a gram" do
      gram = FactoryBot.create(:gram)
      delete :destroy, params: { id: gram.id }
  ...
  describe "grams#update action" do
    it "shouldn't let users who didn't create the gram to update it" do
    gram = FactoryBot.create(:gram)
    user = FactoryBot.create(:user)
    sign_in user
  ...
  describe "grams#edit action" do
    it "shouldn't let a user who did not create the gram to edit a gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "should return a 404 error message if the gram is not found" do
      user = FactoryBot.create(:user)
      sign_in user
    get :edit, params: { id: 'TACOCAT20xx' }
    expect(response).to have_http_status(:not_found)
    end
  end
